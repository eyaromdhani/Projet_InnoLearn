...
class Cours
{
    ...
    #[ORM\Column(options: ["default" => 0])]
    private ?int $completionsCount = 0;

    #[ORM\ManyToOne]
    private ?Formulaire $quiz = null;
    ...
    public function setCompletionsCount(int $completionsCount): static
    {
    ...
    public function getQuiz(): ?Formulaire
    {
        return $this->quiz;
    }

    public function setQuiz(?Formulaire $quiz): static
    {
        $this->quiz = $quiz;
