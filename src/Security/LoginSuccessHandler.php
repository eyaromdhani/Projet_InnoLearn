    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token): RedirectResponse
    {
        ...
        if (!$request->getSession()->get('mfa_verified')) {
            ...
            if ($keyAuthDevMode) {
                ...
                $request->getSession()->getFlashBag()->add('info', 'MFA dev mode active: verification code is displayed on screen.');
            } else {
            ...
            if ($keyAuthDevMode) {
                ...
                $request->getSession()->getFlashBag()->add('info', 'Verification code sent to your email (Dev Mode: Check logs)');
            }
