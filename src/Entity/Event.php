...
class Event
{
    ...
    #[ORM\OneToMany(mappedBy: 'event', targetEntity: InscritEvent::class, cascade: ['remove'])]
    ...
    public function addInscription(InscritEvent $inscription): static
    {
    ...
    public function removeInscription(InscritEvent $inscription): static
    {
    ...
    public function getConfirmedInscriptionsCount(): int
    {
        return $this->inscriptions->filter(fn($i) => $i->getStatus() === 'Confirmé')->count();
    }

    public function getRemainingCapacity(): int
    {
        return max(0, $this->capacite - $this->getConfirmedInscriptionsCount());
    }

    public function isFull(): bool
    {
        return $this->getConfirmedInscriptionsCount() >= $this->capacite;
    }
}
