...
class OffreStageRepository extends ServiceEntityRepository
{
    ...
    public function searchAllStages(string $input = '', ?int $duree = null, string $sort = 'desc', ?string $entreprise = null, ?\DateTimeInterface $minDate = null, ?\DateTimeInterface $maxDate = null, ?\App\Entity\User $recruteur = null, ?string $domaine = null): array
    {
