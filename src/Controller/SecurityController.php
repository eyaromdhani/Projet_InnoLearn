...
{
    #[Route('/login.php', name: 'app_login_legacy_php', methods: ['GET'])]
    #[Route('/login.php/', name: 'app_login_legacy_php_slash', methods: ['GET'])]
    public function legacyLoginPhpRedirect(): Response
    {
